...
:::note
[Using `man` Command]
El comando `man` muestra manuales de comandos en Linux y MacOS. Utilice `--help` para obtener una funcionalidad similar en Git Bash.
:::
...
El comando `whoami` muestra el usuario que ha iniciado sesión actualmente.
:::
...
El comando `fecha` muestra la fecha y hora actuales.
:::
...
La navegación por el sistema de archivos es fundamental para el uso del terminal.
:::| Comando | Descripción | 
| ----------------------------------- | --------------------------------------------------------------------------------- | 
...
:::-Mac:`open [dirname]`- Ventanas:`start [dirname]`-Linux:`xdg-open [dirname]`
...
Aprenda a crear, eliminar, mover y cambiar el nombre de archivos y directorios.
:::| Comando | Descripción | 
| --------------------------- | --------------------------------------------------- | 
...
:::note
[Concatenate Files]
`cat` muestra o crea archivos y los combina.
:::
...
:::tip
[View File Contents]
Desplácese por un archivo con "menos".
:::
...
:::note
[Edit Text Files]
`nano` es un editor de texto fácil de usar.
:::
...
:::note
[Search File Content]
Busque patrones de texto en archivos.
:::
...
Busque archivos por nombre, patrón o propiedades.
:::
...
:::tip
[Redirect Output]
Canalice la salida de un comando a otro.
:::
...
:::note
[Create Shortcuts]
Crea enlaces simbólicos a archivos.
:::
...
:::important
[Manage Archives]
Crea y extrae archivos tar con `tar`.
:::| Comando | Descripción | 
| ----------------------------------- | -------------------------- | 
...
:::important
:::Agregué todos los comandos de terminal que se conocen en este[TerCli](https://tercli.netlify.app/)
