...
:::note
[The KDD Process]
![el proceso kdd](https://upload.Wikimedia.org/Wikipedia/Commons/Thumb/B1/B1/B1/B1/B1/B1/B1/B120px-Crg-kdd-Pdd-PDD.SVG.PNG)
:::
...
Se podría utilizar un modelo de clasificación para identificar a los solicitantes de préstamos como riesgos crediticios bajos, medios o altos.
:::* **Regresión**: los modelos de regresión predicen un valor continuo.

:::tip
[Example of Regression]
Se podría utilizar un modelo de regresión para predecir el precio de venta de una casa en función de sus características.
:::
...
En 2006, AOL publicó un gran conjunto de datos de consultas de búsqueda anónimas con fines de investigación. Sin embargo, los investigadores pudieron eliminar el anonimato de algunos de los usuarios al cruzar las consultas de búsqueda con otra información disponible públicamente.
:::
...
Es fundamental desarrollar y utilizar algoritmos de minería de datos conscientes de la equidad que puedan mitigar el impacto del sesgo en los datos. Esta es un área activa de investigación.
:::
