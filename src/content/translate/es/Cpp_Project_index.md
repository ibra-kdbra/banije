...
description: "Conozca los fundamentos del lenguaje de programación C++, sus ventajas y desventajas."
image: './cpp.jpg'
...
2. Bjarne Stroustrup. (2024). *C++: una introducción completa*. Obtenido de[C++ Programming Resources](https://www.stroustrup.com/). 
3. Cplusplus.com. (2024). *Referencia de C++*. Obtenido de[cplusplus.com](http://www.cplusplus.com/).