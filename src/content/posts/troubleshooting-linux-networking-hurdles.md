...
The goal was straightforward: I needed to route my traffic through a specific `<region>` node to maintain consistency for my cloud profiles, use tools like Gemini without regional friction, and keep my background IDE agent pipelines streaming smoothly.
...
:::caution[The Problem]
Even though the tunnel was active, my internet connection was entirely non-functional. Web pages timed out, Gemini wouldn't load, and my terminal tools couldn't reach any external repositories.
:::
